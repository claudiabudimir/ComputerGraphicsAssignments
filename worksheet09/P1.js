function init() {
    ...
    var projectMatrix = gl1.getUniformLocation(program_ground1, 'projectMatrix');
    var pj = perspective(fovy, aspect, near, far);
    gl1.uniformMatrix4fv(projectMatrix, false, flatten(pj));

    var modelViewMatrixLoc = gl1.getUniformLocation(program_ground1, "modelViewMatrix");
    ...
    var a_Position = gl1.getAttribLocation(program_ground1, "a_Position");
    ...
    var a_TexCoord = gl1.getAttribLocation(program_ground1, "a_TexCoord");
